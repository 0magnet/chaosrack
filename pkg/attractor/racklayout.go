...
//
// There used to be twenty-eight of them — one per module, generated by the
// rack plus eight written by hand — and they were the Console's whole middle
// column and most of its width. They are gone: a module is in the rack.
// Hiding one was a way to make the panel smaller that cost a column of
// switches to offer, and a module nobody can see is a control nobody can
// find.
//
// What is left is the two things that are not modules:
//
//   - "scope-on" bolts in the rack-mount oscilloscope, which is a UNIT — a
//     19-inch instrument of its own, not a card in a subrack opening.
//   - "tpl-on" shows the Template legend, which is documentation about what a
//     module can hold rather than an instrument. A rack does not permanently
//     carry its own drawings.
//
