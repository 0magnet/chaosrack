...
var verticesNative = []float32{ //nolint:unused // built but not wired up yet; kept deliberately
...
var colorsNative = []float32{ //nolint:unused // built but not wired up yet; kept deliberately
...
var indicesNative = []uint32{ //nolint:unused // built but not wired up yet; kept deliberately
	0, 1, 2, 0, 2, 3, 4, 5, 6, 4, 6, 7,
	8, 9, 10, 8, 10, 11, 12, 13, 14, 12, 14, 15,
	16, 17, 18, 16, 18, 19, 20, 21, 22, 20, 22, 23,
}

func generateSphereVertices(radius float32, stacks, slices int) ([]float32, []uint32) { //nolint:unused // built but not wired up yet; kept deliberately
